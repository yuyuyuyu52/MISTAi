...
const translations = {
  ...
  "hero.startProject": { zh: "启动项目", en: "START A PROJECT" },
  ...
  "events.heading2": { zh: "与社区", en: "EVENTS" },
  "events.desc": {
  ...
  "events.past": { zh: "往期回顾", en: "Past Events" },
  "events.event1.title": { zh: "AI Demo Day 2025", en: "AI Demo Day 2025" },
  "events.event1.date": { zh: "2025年6月 · 杭州", en: "June 2025 · Hangzhou" },
  "events.event1.desc": {
    zh: "汇聚 30+ AI 创业项目路演，对接一线投资机构与产业资本。",
    en: "30+ AI startup project demos, connecting with top-tier VCs and industry capital.",
  },
  "events.event2.title": { zh: "全球 AI Agent 出海峰会", en: "Global AI Agent Expansion Summit" },
  "events.event2.date": { zh: "2025年8月 · 新加坡", en: "August 2025 · Singapore" },
  "events.event2.desc": {
    zh: "探讨 AI Agent 应用的全球化路径与跨境增长策略。",
    en: "Exploring global pathways and cross-border growth strategies for AI Agent applications.",
  },
  "events.event3.title": { zh: "AI × 制造业闭门研讨会", en: "AI × Manufacturing Roundtable" },
  "events.event3.date": { zh: "2025年5月 · 深圳", en: "May 2025 · Shenzhen" },
  "events.event3.desc": {
    zh: "聚焦工业视觉与智能检测在制造业中的最新落地实践。",
    en: "Focusing on the latest industrial vision and smart inspection practices in manufacturing.",
  },
  "events.register": { zh: "立即报名", en: "REGISTER NOW" },
  "events.review": { zh: "查看回顾", en: "VIEW RECAP" },
