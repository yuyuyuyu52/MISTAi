...
const translations = {
  ...
  "events.event1.topic": { zh: "Agentic AI 及大模型企业落地：探讨安全峰会背景下的 Agentic AI 趋势、生成式 AI 带来的安全攻击链挑战及 OpenClaw 的数据合规。", en: "Agentic AI & Enterprise LLM Deployment: Exploring Agentic AI trends, generative AI security challenges, and OpenClaw data compliance." },
  "events.event2.title": { zh: "MIST Ai Talk 第十一期", en: "MIST Ai Talk #11" },
  "events.event2.date": { zh: "2026.4.12 · 杭州", en: "Apr 12, 2026 · Hangzhou" },
  "events.event2.topic": { zh: "从产品落地到海外增长：聚焦 AI Agent 出海的冷启动、定价模型与渠道破局，探讨如何从技术 demo 走向规模化海外商业增长。", en: "From Product to Overseas Growth: AI Agent cold start, pricing models, and channel strategies for scaling global commercial growth." },
  "events.event3.title": { zh: "MIST Ai Talk 第十期", en: "MIST Ai Talk #10" },
  "events.event3.date": { zh: "2026.3.28 · 上海", en: "Mar 28, 2026 · Shanghai" },
  "events.event3.topic": { zh: "大家一起玩（夺回数字主权）：探讨构建「有灵魂」的个人 Agent，以及 OpenClaw 在各大生态中的落地应用与交互重构。", en: "Reclaiming Digital Sovereignty: Building personal Agents with soul, and OpenClaw's ecosystem integration and interaction reimagination." },
  "events.event4.title": { zh: "MIST Ai Talk 第九期", en: "MIST Ai Talk #9" },
  "events.event4.date": { zh: "2026.3.14 · 杭州", en: "Mar 14, 2026 · Hangzhou" },
  "events.event4.topic": { zh: "OpenClaw 搞钱派对：引领 AI 从「工具」向「协作伙伴」迈进，展示「数字员工」在多智能体协同、全栈智能体大脑等方面的落地能力。", en: "OpenClaw Party: AI evolving from tool to collaborative partner — showcasing digital employees in multi-agent orchestration and full-stack agent brains." },
  "events.event5.title": { zh: "MIST Ai Talk 第八期", en: "MIST Ai Talk #8" },
  "events.event5.date": { zh: "2026.2.7 · 杭州", en: "Feb 7, 2026 · Hangzhou" },
  "events.event5.topic": { zh: "拟人 AI 键盘，重塑社交智能：从「卷算法」转向「用 AI 编排商业增长」，探讨具有「人感」和多模态记忆系统的社交伙伴。", en: "Humanoid AI Keyboard — Reshaping Social Intelligence: From algorithm wars to AI-orchestrated business growth, exploring human-like social companions with multimodal memory." },
  "events.event6.title": { zh: "MIST Ai Talk 第七期", en: "MIST Ai Talk #7" },
  "events.event6.date": { zh: "2026.1.31 · 杭州", en: "Jan 31, 2026 · Hangzhou" },
  "events.event6.topic": { zh: "驱动业务新引擎：AI Coding 的确定性交付：探讨 AI 原生工作流、企业专属模型以及如何推动 AI 编程向一次成功转型。", en: "AI Coding as Business Engine: Deterministic delivery through AI-native workflows, enterprise-specific models, and first-time-right AI programming." },
  "events.event7.title": { zh: "MIST Ai Talk 第六期", en: "MIST Ai Talk #6" },
  "events.event7.date": { zh: "2026.1.24 · 北京", en: "Jan 24, 2026 · Beijing" },
  "events.event7.topic": { zh: "AI 商业模式探讨与行业趋势分析：直面技术不再稀缺后的现实问题，从硬件、企服、资本等维度解构 AI 商业化的核心逻辑。", en: "AI Business Models & Industry Trends: Deconstructing AI commercialization logic across hardware, enterprise services, and capital dimensions." },
  "events.event8.title": { zh: "MIST Ai Talk 第五期", en: "MIST Ai Talk #5" },
  "events.event8.date": { zh: "2026.1.17 · 杭州", en: "Jan 17, 2026 · Hangzhou" },
  "events.event8.topic": { zh: "AI 创业者观察：AIGC 价值型交付：探讨以效果付费模式重塑 AIGC 价值，以及 Agent 商业化实践中的产品研发变革。", en: "AI Founder Insights: AIGC Value Delivery — reshaping AIGC value through performance-based models and product R&D transformation in Agent commercialization." },
  "events.event9.title": { zh: "MIST Ai Talk 第四期", en: "MIST Ai Talk #4" },
  "events.event9.date": { zh: "2026.1.10 · 杭州", en: "Jan 10, 2026 · Hangzhou" },
  "events.event9.topic": { zh: "重定义·企业智能：从 Agent 数字团队到 GEO（生成式优化）品牌重塑，探讨搜索引擎从「关键词」向「对话式」的转变。", en: "Redefining Enterprise Intelligence: From Agent digital teams to GEO (Generative Engine Optimization) brand reinvention and conversational search." },
  "events.event10.title": { zh: "MIST Ai Talk 第三期", en: "MIST Ai Talk #3" },
  "events.event10.date": { zh: "2025.12.27 · 杭州", en: "Dec 27, 2025 · Hangzhou" },
  "events.event10.topic": { zh: "构建深度理解用户的 AI 助理：侧重于 AI 知识库与个人数字记忆的搭建，解决「AI 不够懂我」的痛点。", en: "Building AI Assistants That Truly Understand Users: Focusing on AI knowledge bases and personal digital memory to solve the 'AI doesn't get me' problem." },
  "events.event11.title": { zh: "MIST Ai Talk 第二期", en: "MIST Ai Talk #2" },
  "events.event11.date": { zh: "2025.12.19 · 杭州", en: "Dec 19, 2025 · Hangzhou" },
  "events.event11.topic": { zh: "具身智能机器人：深度剖析具身机器人与传统 AI 的区别，梳理从概念到产业化的路径，探讨感知、决策、控制等核心技术在智能制造和社会服务中的应用。", en: "Embodied Intelligent Robots: Deep analysis of embodied robots vs traditional AI, from concept to industrialization — perception, decision-making, and control in smart manufacturing and social services." },
  "events.event12.title": { zh: "MIST Ai Talk 第一期", en: "MIST Ai Talk #1" },
  "events.event12.date": { zh: "2025.12.14 · 杭州", en: "Dec 14, 2025 · Hangzhou" },
  "events.event12.topic": { zh: "从「能力构建」到「产业落地」：AI 应用化的关键一跃：重点探讨 AI 如何赋能设计创新与企业级服务升级，开启从技术 demo 向产业实战的转型讨论。", en: "From Capability Building to Industry Implementation: The Critical Leap in AI Application — exploring how AI empowers design innovation and enterprise service upgrades." },
